...
public class ShowBooksAdapter extends RecyclerView.Adapter<ShowBooksAdapter.BookHolder>{

    private List<Book> books;
    private Context context;

    public ShowBooksAdapter(ArrayList<Book> books, Context context) {
        this.books = books;
    ...
    @NonNull
    @Override
    public ShowBooksAdapter.BookHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ShowBooksAdapter.BookHolder holder, int position) {
